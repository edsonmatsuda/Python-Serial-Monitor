...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setBold(True)
        font.setWeight(75)
        self.comboBox_DataSize.setFont(font)
        ...
        self.text_Receive.setFont(font)
        ...
        self.checkBox_CR.setGeometry(QtCore.QRect(970, 684, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.checkBox_LF.setGeometry(QtCore.QRect(970, 710, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def repeat(self):
        ...
        if repeatFlag == False:
            repeatFlag = True
            repeatOn = True
            self.btn_Repeat.setText("Stop Rep.")
            self.btn_Send.setDisabled(True)
